...
public class flowerEffect1 : MonoBehaviour
{
    public GameObject pivot;
    public GameObject Bpetal;
    public GameObject BpetalPivot;
    public GameObject Apetal;
    public GameObject ApetalPivot;

    int counter = 0;
    int random = 5;
    int reversal = 1;
    Vector3 origin, origin2, origin3;
    static float angle, angle2, angle3;
    // Use this for initialization
    void Start()
    {
        origin = gameObject.transform.up;
        origin2 = Bpetal.transform.up;
        origin3 = Apetal.transform.up;
    ...
    void Update()
    {
        ...
        angle2 = Vector3.SignedAngle(origin3, Apetal.transform.up, ApetalPivot.transform.up);
        angle3 = Vector3.SignedAngle(origin2, Bpetal.transform.up, BpetalPivot.transform.up);
