...
namespace UntitledTools {
	namespace VertexWindNamespace {
		...
		[AddComponentMenu("Untitled Tools/Vertex Wind/Wind Effector Radius")]
		public class WindEffectorRadius : MonoBehaviour {

			//The settings for the wind effector radius script
			[Space(10f)]
			[Header("- Wind Radius Effector Settings -")]
			[Space(10f)]
			...
			public float ScriptPointSize = 2f;

			private VertexWind[] VertexWindScripts;
			private List<VertexWind> AvailableScripts = new List<VertexWind> ();
			private List<VertexWind> OutsideScripts = new List<VertexWind> ();
			...
			void Update () {
				...
				VertexWindScripts = VertexWind.FindObjectsOfType<VertexWind> ();
